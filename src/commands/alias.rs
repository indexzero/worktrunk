...
/// approved-commands copy. Project config uses the standard source selector so
/// aliases from `worktrunk.config.*` appear here too.
///
...
/// Load project aliases without surfacing discovery-time errors.
